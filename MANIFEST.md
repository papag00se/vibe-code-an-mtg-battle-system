...
- `prompts/00_clone_the_repo.md`
- `prompts/01_bootstrap_repo.md`
- `prompts/02_build_card_search.md`
- `prompts/03_build_card_anatomy.md`
- `prompts/04_build_zones_and_state.md`
- `prompts/05_build_turns_mana_casting.md`
- `prompts/06_build_stack_priority.md`
- `prompts/07_build_combat_keywords.md`
- `prompts/08_polish_resource_panel.md`
